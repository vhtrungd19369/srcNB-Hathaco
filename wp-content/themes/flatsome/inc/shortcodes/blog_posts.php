...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
        ...
        <div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
          ...
          <?php } ?>
                    ...
                    <?php } ?>
                    <a href="<?php the_permalink() ?>" class="plain">
                    <h5 class="post-title is-<?php echo $title_size; ?> <?php echo $title_style;?>"><?php the_title(); ?></h5></a>
                    <p class="ngay-dang-bai"><?php echo get_the_date(); ?></p>
                ...
                <?php }?>
                    ...
                    <a class="link-xem-chi-tiet" href="<?php the_permalink() ?>" class="plain"><button class="xem-chi-tiet"><< Xem chi tiết tin đăng >></button></a>
