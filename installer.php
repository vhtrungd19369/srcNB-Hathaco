...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210308_mauwebraovatbatdongsan_24f2eebeb4527c4e2971_20210308085322_archive.daf';
    const ARCHIVE_SIZE       = '38110314';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '24f2eeb-08085322';
    const SECONDARY_PACKAGE_HASH = '8a34aea-08085322';
